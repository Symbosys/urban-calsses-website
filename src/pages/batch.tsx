...
const BatchesPage = () => {
  ...
  return (
    <div
      className={`pt-36 min-h-screen transition-all duration-700 ${
    ...
    >
      ...
      <section className="relative py-24 lg:py-32 overflow-hidden border-b border-white/5">
        <div className="absolute inset-0 pointer-events-none">
          <div
            className={`absolute top-0 right-0 w-[800px] h-[800px] rounded-full blur-[200px] transition-all duration-1000 ${
              theme === "dark" ? "bg-blue-600/10" : "bg-blue-200/30"
            }`}
          />
          <div
            className={`absolute bottom-0 left-0 w-[600px] h-[600px] rounded-full blur-[150px] transition-all duration-1000 ${
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          ...
          >
            <div
              className={`inline-flex items-center gap-2 px-4 py-1.5 rounded-full mb-8 backdrop-blur-md border ${
                theme === "dark"
            ...
            >
              ...
              <span className="text-[10px] font-black uppercase tracking-[0.2em]">
                Unlimited Batches — One Goal: Rankers
              </span>
            </div>
            <h1
              className={`text-5xl md:text-8xl font-black mb-8 tracking-tighter transition-colors leading-[0.9] ${
            ...
            <p
              className={`text-xl font-medium max-w-2xl mx-auto mb-16 leading-relaxed ${
                theme === "dark" ? "text-slate-400" : "text-slate-600"
              }`}
            >
              Browse through our premium selection of batches designed by
              India's legendary faculty to secure your seat in top colleges.
            </p>
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col lg:flex-row gap-16">
            ...
            <aside className="lg:col-span-3 xl:w-80">
              <div
                className={`sticky top-40 p-10 rounded-[3rem] border transition-all ${
                  theme === "dark"
                    ? "bg-[#161b2c]/40 border-white/5"
              ...
              >
                <div className="flex items-center gap-3 mb-10">
                  ...
                  <h4
                    className={`text-xs font-black uppercase tracking-widest ${theme === "dark" ? "text-white" : "text-slate-900"}`}
                  >
                    Filter Results
                  </h4>
                </div>
                ...
                <div className="mt-16 pt-10 border-t border-white/5">
                  ...
                  <p className="text-[10px] font-bold text-slate-500 leading-relaxed uppercase tracking-widest">
                    Join 500,000+ Students already learning today.
                  </p>
                </div>
              </div>
            </aside>
              ...
              <AnimatePresence mode="popLayout">
                {filtered.length > 0 ? (
                      ...
                      >
                        ...
                        <div className="p-10 flex-1">
                          <div className="flex justify-between items-start mb-8">
                            <span
                              className={`px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest bg-gradient-to-br ${batch.color} text-white`}
                            >
                              {batch.tag}
                            </span>
                          ...
                          <h3
                            className={`text-3xl font-black mb-3 tracking-tight group-hover:text-blue-500 transition-colors ${
                              theme === "dark" ? "text-white" : "text-slate-900"
                            }`}
                          >
                            {batch.name}
                          </h3>
                          <p className="text-blue-500 text-[10px] font-black uppercase tracking-widest mb-10">
                            {batch.target}
                          </p>
                          ...
                          <div className="flex items-center gap-6 pb-10">
                            <div className="flex -space-x-3">
                              {batch.faculty.map((f, j) => (
                                <div
                                  key={j}
                                  className="w-10 h-10 rounded-full border-2 border-slate-900 bg-slate-700 flex items-center justify-center text-[10px] font-black text-white"
                                >
                                  {f}
                                </div>
                              ))}
                        ...
                        {/* Card Bottom CTA */}
                        <div
                          className={`p-10 pt-8 border-t transition-colors flex items-center justify-between ${
                            theme === "dark"
                        ...
                        >
                          <div className="flex flex-col">
                            <div className="flex items-center gap-3">
                              ...
                              <div className="px-2 py-0.5 bg-emerald-500/10 text-emerald-500 text-[8px] font-black rounded uppercase">
                                Save 50%
                              </div>
                            </div>
                            <span className="text-slate-500 line-through text-xs font-bold opacity-50">
                              ₹{batch.originalPrice}
                            </span>
                          </div>
                          ...
                          <div className="flex items-center gap-4">
                            ...
                            <Link
                              to="/live-class"
                              className="px-8 py-4 bg-blue-600 text-white rounded-2xl text-[10px] font-black uppercase tracking-widest shadow-xl shadow-blue-600/20 hover:scale-105 active:scale-95 transition-all"
                            >
                              Buy Now
                            </Link>
                          </div>
                  ...
                  >
                    ...
                    <h3
                      className={`text-3xl font-black mb-4 ${theme === "dark" ? "text-white" : "text-slate-900"}`}
                    >
                      No Matches Found
                    </h3>
                    <p className="text-slate-500 font-bold max-w-sm mx-auto uppercase text-[10px] tracking-[0.2em]">
      ...
      <section
        className={`py-40 mt-20 border-t ${
          theme === "dark"
          ...
          <div className="grid md:grid-cols-4 gap-12">
            {[
              ...
              <div key={stat.lab} className="group">
                ...
                <h4
                  className={`text-4xl font-black mb-2 tracking-tighter ${theme === "dark" ? "text-white" : "text-slate-900"}`}
                >
                  {stat.val}
                </h4>
