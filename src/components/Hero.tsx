...
const banners = [
  ...
  {
    image:
      "https://images.unsplash.com/photo-1501504905953-f8a979207e99?q=80&w=2070&auto=format&fit=crop",
...
const Hero = () => {
  ...
  return (
    <section
      className={`relative w-full h-[60vh] md:h-[80vh] lg:h-[85vh] overflow-hidden transition-colors duration-500 ${
